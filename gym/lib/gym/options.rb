    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :output_name,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :output_name_pattern,
                                     short_option: "-np",
                                     env_name: "GYM_OUTPUT_NAME_PATTERN",
                                     description: "The name pattern of the resulting ipa file. When used with aggregrated targets, the wildcard character '*' is replaced with the current target to be exported",
                                     optional: true),
        ...
        FastlaneCore::ConfigItem.new(key: :skip_archive,
                                     ...
                                     type: Boolean,
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :aggregate_targets,
                                     short_option: "-at",
                                     env_name: "GYM_AGGREGRATE_TARGETS",
                                     description: "Pass a list of targets which are included in the generated archive.",
                                     is_string: false,
                                     type: Array,
                                     optional: true),
        # Very optional
        FastlaneCore::ConfigItem.new(key: :build_path,
                                     ...
                                     description: "The directory in which the archive should be stored",
                                     optional: true),
